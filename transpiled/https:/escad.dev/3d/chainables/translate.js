...
export const translate = Component.create("translate", (...args) => {
    ...
    return mapOperation("translate", (mesh) => Transform.create(TupleProduct.create([matrix, mesh])), { showOutput: false });
}, { showOutput: false });
export const tX = Component.create("tX", (n) => translate({ x: n }), {
    showOutput: false,
});
export const tY = Component.create("tY", (n) => translate({ y: n }), {
    showOutput: false,
});
export const tZ = Component.create("tZ", (n) => translate({ z: n }), {
    showOutput: false,
});

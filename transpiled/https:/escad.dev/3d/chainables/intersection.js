...
const intersectionId = Id.create(import.meta.url, "@escad/3d", "Marker", "Intersection");
...
conversionRegistry.register({
  ...
  weight: 1,
  id: Id.create(import.meta.url, "@escad/3d", "Conversion", "Intersection")
});
export const intersection = Operation.create("intersection", async el => Intersection.create(TupleProduct.create(await Element.toArrayFlat(el))), {
  showOutput: false
});

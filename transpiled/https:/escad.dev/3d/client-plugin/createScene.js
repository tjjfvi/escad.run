...
import { createOrientCube } from "/transpiled/https://escad.dev/3d/client-plugin/orientCube.js";
import { createCylAxes, createLineAxes } from "/transpiled/https://escad.dev/3d/client-plugin/axes.js";
export const createScene = () => {
  ...
  const orientRenderer = new t.WebGLRenderer({
    antialias: true,
    alpha: true
  });

...
function getHierarchyPathPart(pathPart, hierarchy) {
    ...
    while (hierarchy.type === "CallHierarchy" &&
    ...
    if (hierarchy.type !== "CallHierarchy" &&
        pathPart.type === "CallHierarchyPathPart" &&
        pathPart.location === "onlyOperand") {
        return hierarchy;
    }
    if (pathPart.type === "CallHierarchyPathPart" &&

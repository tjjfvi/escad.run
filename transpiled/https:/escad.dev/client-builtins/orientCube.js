...
export function createOrientCube(getCamera, controls) {
    ...
    let corners = [
        ...
        mesh.rotateZ(z);
        mesh.rotateX(x);
        mesh.position.set(cubeSize / 2, cubeSize / 2, cubeSize / 2)
    ...
    group.add(...parts);
    group.add(new t.LineSegments(new t.EdgesGeometry(new t.BoxGeometry(.5, .5, .5)), new t.LineBasicMaterial({ color: colors.lightgrey })));

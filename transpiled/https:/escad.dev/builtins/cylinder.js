...
import { smoothContext } from "/transpiled/https://escad.dev/builtins/smoothContext.js";
import { Vector3 } from "/transpiled/https://escad.dev/builtins/Vector3.js";
const tau = Math.PI * 2;
const cylinderId = Id.create(import.meta.url, "@escad/builtins", "LeafProduct", "Cylinder");
...
conversionRegistry.register({
    ...
    convert: async (cyl) => {
        ...
        return Mesh.create([...Array(sides)].flatMap((_, i) => {
            ...
            let p2 = [
                Math.cos((i + 1) / sides * tau) * radius,
                Math.sin((i + 1) / sides * tau) * radius,
            ];

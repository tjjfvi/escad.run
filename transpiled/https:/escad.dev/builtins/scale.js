...
import { FlipFaces } from "/transpiled/https://escad.dev/builtins/flip.js";
export const scale = Component.create("scale", (...args) => {
    ...
    let arr = triple instanceof Array
        ? triple
        : [triple.x ?? 1, triple.y ?? 1, triple.z ?? 1];
...
export const sX = Component.create("sX", (n) => scale({ x: n }), { showOutput: false });
export const sY = Component.create("sY", (n) => scale({ y: n }), { showOutput: false });
export const sZ = Component.create("sZ", (n) => scale({ z: n }), { showOutput: false });

...
export const convert = GenericComponent.create("convert", (productTypeish) => {
    ...
    return Operation.create("convert", (element) => Element.map(element, (product) => Element.create(conversionRegistry.convertProduct(productType, product))), { showOutput: false });
}, { showOutput: false });

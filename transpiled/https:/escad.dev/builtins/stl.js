import { exportTypeRegistry, Hash, Id } from "/transpiled/https://escad.dev/core/mod.js";
...
exportTypeRegistry.register({
    ...
    export: async (meshes) => {
        ...
        new TextEncoder().encodeInto("@escad/builtins/stl/" + Hash.create(meshes), new Uint8Array(buffer));

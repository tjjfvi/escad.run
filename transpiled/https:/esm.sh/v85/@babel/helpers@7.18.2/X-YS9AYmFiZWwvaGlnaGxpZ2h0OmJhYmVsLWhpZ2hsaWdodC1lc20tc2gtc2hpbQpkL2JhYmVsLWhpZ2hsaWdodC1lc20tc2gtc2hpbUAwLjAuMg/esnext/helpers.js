/* esm.sh - esbuild bundle(@babel/helpers@7.18.2) esnext production */
...
var u = (r, n) => O(r, "name", {
  ...
  configurable: !0
    ...
    x = (r => typeof require != "undefined" ? require : typeof Proxy != "undefined" ? new Proxy(r, {
...
var X = (r, n, i, s) => {
  if (n && typeof n == "object" || typeof n == "function") for (let l of Z(n)) !Q.call(r, l) && l !== i && O(r, l, {
    get: () => n[l],
    enumerable: !(s = Y(n, l)) || s.enumerable
  });
  return r;
};

var R = (r, n, i) => (i = r != null ? U(J(r)) : {}, X(n || !r || !r.__esModule ? O(i, "default", {
  value: r,
  enumerable: !0
}) : i, r));
...
var z = F(k => {
  ...
  k.default = void 0;
  var ee = ___babel_template$;

  function b(r, n) {
    return Object.freeze({
      minVersion: r,
      ast: () => ee.default.program.ast(n, {
        preserveComments: !0
      })
    });
  }
...
`;
  e.AsyncGenerator = t("7.0.0-beta.0")`
...
`;
  e.awaitAsyncGenerator = t("7.0.0-beta.0")`
  import AwaitValue from "AwaitValue";
...
`;
  e.asyncGeneratorDelegate = t("7.0.0-beta.0")`
...
var T = F(f => {
  ...
  function K(r) {
    let n = new Set(),
        ...
        g = {
      ImportDeclaration(o) {
        let a = o.node.source.value;
        if (!I.default[a]) throw o.buildCodeFrameError(`Unknown helper ${a}`);
        if (o.get("specifiers").length !== 1 || !o.get("specifiers.0").isImportDefaultSpecifier()) throw o.buildCodeFrameError("Helpers can only import a default value");
        let p = o.node.specifiers[0].local;
        s.set(p, a), m.push(E(o));
      },

      ExportDefaultDeclaration(o) {
        let a = o.get("declaration");
        if (!a.isFunctionDeclaration() || !a.node.id) throw a.buildCodeFrameError("Helpers can only export named function declarations");
        l = a.node.id.name, y = E(o);
      },

      ExportAllDeclaration(o) {
        throw o.buildCodeFrameError("Helpers can only export default");
      },
      ...
      Statement(o) {
        o.isModuleDeclaration() || o.skip();
      }

    },
        C = {
      Program(o) {
        let a = o.scope.getAllBindings();
        Object.keys(a).forEach(p => {
          p !== l && (s.has(a[p].identifier) || i.add(p));
        });
      },

      ReferencedIdentifier(o) {
        let a = o.node.name,
            p = o.scope.getBinding(a);
        p ? s.has(p.identifier) && w.push(E(o)) : n.add(a);
      },
      ...
      AssignmentExpression(o) {
        ...
        let p = o.scope.getBinding(l);
        p != null && p.scope.path.isProgram() && h.push(E(o));
      }

    };
    if ((0, A.default)(r.ast, g, r.scope), (0, A.default)(r.ast, C, r.scope), !y) throw new Error("Helpers must have a default export.");
    return h.reverse(), {
      ...
      exportPath: y,
      exportName: l,
      importBindingsReferences: w,
      importPaths: m
    };
  }

  u(K, "getHelperMetadata");

  function ce(r, n, i, s, l) {
    if (s && !i) throw new Error("Unexpected local bindings for module-based helpers.");
    if (!i) return;
    let {
      localBindingNames: y,
      dependencies: h,
      ...
      importPaths: o
        ...
        a = {};
    h.forEach((c, d) => {
      a[d.name] = typeof l == "function" && l(c) || d;
    });
    let p = {},
        H = new Set(s || []);
    y.forEach(c => {
      ...
      d !== c && (p[c] = d);
    }), i.type === "Identifier" && g !== i.name && (p[g] = i.name);
    let {
      path: v
    } = r,
        S = v.get(w),
        ...
        q = C.map(c => v.get(c)),
        M = S.get("declaration");
    if (i.type === "Identifier") S.replaceWith(M);else if (i.type === "MemberExpression") m.forEach(c => {
      let d = v.get(c);
      d.replaceWith(N("=", i, d.node));
    }), S.replaceWith(M), v.pushContainer("body", se(N("=", i, le(g))));else throw new Error("Unexpected helper format.");
    Object.keys(p).forEach(c => {
      v.scope.rename(c, p[c]);
    });

    for (let c of $) c.remove();

    for (let c of q) {
      let d = ae(a[c.node.name]);
      c.replaceWith(d);
    }
  }

  u(ce, "permuteHelperAST");
  ...
  function _(r) {
    if (!D[r]) {
      ...
      D[r] = {
        ...
        getDependencies() {
          return s || (s = K(i())), Array.from(s.dependencies.values());
        }
  ...
  function W(r, n, i, s) {
    return _(r).build(n, i, s);
  }

  u(W, "get");

  function pe(r) {
    return _(r).minVersion;
  }

  u(pe, "minVersion");

  function ue(r) {
    return _(r).getDependencies();
  }

  u(ue, "getDependencies");
  ...
  u(de, "ensure");
  var fe = Object.keys(I.default).map(r => r.replace(/^_/, ""));
  f.list = fe;
  var ye = W;
  f.default = ye;
});
var V = R(T()),
  ...
  ...he
    ...
    Ce = V.default ?? me ?? he;
export { xe as __esModule, Ce as default, ke as ensure, Pe as get, Ee as getDependencies, je as list, _e as minVersion };
...
var g = (a, e, s, f) => {
  if (e && typeof e == "object" || typeof e == "function") for (let l of E(e)) !S.call(a, l) && l !== s && t(a, l, {
    get: () => e[l],
    enumerable: !(f = d(e, l)) || f.enumerable
  });
  return a;
};

var M = (a, e, s) => (s = a != null ? m(p(a)) : {}, g(e || !a || !a.__esModule ? t(s, "default", {
  value: a,
  enumerable: !0
}) : s, a));
...
var u = M(i()),
  ...
  ...v
    ...
    se = c !== void 0 ? c : v;
export { V as amd, K as applescript, Q as atomtest, G as browser, b as builtin, A as commonjs, O as couch, se as default, ae as devtools, J as embertest, I as es2015, C as es2017, R as es5, ee as greasemonkey, F as jasmine, x as jest, w as jquery, $ as meteor, H as mocha, X as mongo, W as nashorn, D as node, B as phantomjs, _ as prototypejs, Y as protractor, k as qunit, N as rhino, z as serviceworker, q as shelljs, Z as webextensions, P as worker, U as wsh, j as yui };
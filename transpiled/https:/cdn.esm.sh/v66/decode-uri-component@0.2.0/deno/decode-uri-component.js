...
var f = w((I, m) => {
    "use strict";
    var v = "%[a-f0-9]{2}", u = new RegExp(v, "gi"), l = new RegExp("(" + v + ")+", "gi");
    function F(r, e) { try {
    ...
    function s(r) { try {
        ...
        for (var e = r.match(u), t = 1; t < e.length; t++)
            r = F(e, t).join(""), e = r.match(u);
        return r;
    } }
    function R(r) { for (var e = { "%FE%FF": "\uFFFD\uFFFD", "%FF%FE": "\uFFFD\uFFFD" }, t = l.exec(r); t;) {
        try {

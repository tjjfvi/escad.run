...
import __path_is_absolute$ from "/transpiled/https://cdn.esm.sh/v66/path-is-absolute@1.0.1/deno/path-is-absolute.js";
import __assert$ from "/transpiled/https://deno.land/std@0.125.0/node/assert.js";
...
import __once$ from "/transpiled/https://cdn.esm.sh/v66/once@1.4.0/deno/once.js";
import __inflight$ from "/transpiled/https://cdn.esm.sh/v66/inflight@1.0.6/deno/inflight.js";
import __events$ from "/transpiled/https://deno.land/std@0.125.0/node/events.js";
import __minimatch$ from "/transpiled/https://cdn.esm.sh/v66/minimatch@3.0.5/deno/minimatch.js";
import __fs_realpath$ from "/transpiled/https://cdn.esm.sh/v66/fs.realpath@1.0.0/deno/fs.realpath.js";
var x = Object.create;
...
var L = j((Qt, X) => { X.exports = A; var pt = __fs_realpath$, V = __minimatch$, Ft = V.Minimatch, wt = __inherits$, kt = __events$.EventEmitter, T = __path$, C = __assert$, O = __path_is_absolute$, F = J(), E = q(), At = E.setopts, M = E.ownProp, P = __inflight$, Pt = __util$, Et = E.childrenIgnored, bt = E.isIgnored, It = __once$; function A(t, r, e) { if (typeof r == "function" && (e = r, r = {}), r || (r = {}), r.sync) {
    if (e)
        throw new TypeError("callback provided to sync glob");
    return F(t, r);
} return new u(t, r, e); } A.sync = F; var Ot = A.GlobSync = F.GlobSync; A.glob = A; function St(t, r) { if (r === null || typeof r != "object")
    return t; for (var e = Object.keys(r), i = e.length; i--;)
    t[e[i]] = r[e[i]]; return t; } A.hasMagic = function (t, r) { var e = St({}, r); e.noprocess = !0; var i = new u(t, e), a = i.minimatch.set; if (!t)
    return !1; if (a.length > 1)
    return !0; for (var n = 0; n < a[0].length; n++)
    if (typeof a[0][n] != "string")
        return !0; return !1; }; A.Glob = u; wt(u, kt); function u(t, r, e) { if (typeof r == "function" && (e = r, r = null), r && r.sync) {
    if (e)
        throw new TypeError("callback provided to sync glob");
    return new Ot(t, r);
    ...
    return r(); var s = this.matches[t] = Object.create(null); i.forEach(function (h, o) { h = a._makeAbs(h), pt.realpath(h, a.realpathCache, function (v, y) { v ? v.syscall === "stat" ? s[h] = !0 : a.emit("error", v) : s[y] = !0, --n === 0 && (a.matches[t] = s, r()); }); }); }; u.prototype._mark = function (t) { return E.mark(this, t); }; u.prototype._makeAbs = function (t) { return E.makeAbs(this, t); }; u.prototype.abort = function () { this.aborted = !0, this.emit("abort"); }; u.prototype.pause = function () { this.paused || (this.paused = !0, this.emit("pause")); }; u.prototype.resume = function () { if (this.paused) {
    ...
    return r(); if (!this.stat && M(this.cache, e)) {
    var a = this.cache[e];

...
import __buffer$ from "/transpiled/https://cdn.esm.sh/v66/node_buffer.js";
var l = Object.create;
...
var y = k((A, g) => {
    ...
    (!a.from || a.from === Uint8Array.from) && (a.from = function (e, r, n) { if (typeof e == "number")
        throw new TypeError('The "value" argument must not be of type number. Received type ' + typeof e); if (e && typeof e.length > "u")

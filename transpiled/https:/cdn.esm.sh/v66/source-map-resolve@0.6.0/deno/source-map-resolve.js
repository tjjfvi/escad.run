...
import __decode_uri_component$ from "/transpiled/https://cdn.esm.sh/v66/decode-uri-component@0.2.0/deno/decode-uri-component.js";
...
import __atob$ from "/transpiled/https://cdn.esm.sh/v66/atob@2.1.2/deno/atob.js";
var B = Object.create;
...
var M = W((te, J) => {
    var T = __atob$, F = __url$, G = __path$, K = __decode_uri_component$;
    function y() { return Array.prototype.reduce.call(arguments, function (e, o) { return F.resolve(e, o); }); }
    function d(e) { return G.sep === "\\" ? e.replace(/\\/g, "/").replace(/^[a-z]:\/?/i, "/") : e; }
    ...
    function L(e, o, u) { var n = p(o); try {
        return String(e(n));
    }
    catch (r) {
        throw r.sourceMapData = u, r;
    } }
    var C = /[#@] sourceMappingURL=([^\s'"]*)/, P = RegExp(`(?:/\\*(?:\\s*\r?
(?://)?)?(?:` + C.source + ")\\s*\\*/|//(?:" + C.source + "))\\s*");
    ...
    function D(e, o, u) { var n = $(e, o); return !n || n.map || (n.map = L(u, n.url, n), n.map = f(n.map, n)), n; }
    var V = /^data:([^,;]*)(;[^,;]*)*(?:,(.*))?$/, X = /^(?:application|text)\/json$/, Y = "utf-8";
    function Z(e) { for (var o = T(e), u = o.length, n = new Uint8Array(u), r = 0; r < u; r++)
        n[r] = o.charCodeAt(r); return n; }
    function b(e) { if (typeof TextDecoder > "u" || typeof Uint8Array > "u")
        return T(e); var o = Z(e), u = new TextDecoder(Y, { fatal: !0 }); return u.decode(o); }
    function $(e, o) { o = d(o); var u = Q(e); if (!u)
    ...
    var k = /\/?$/;
    function q(e, o, u, n) { u = u || {}, o = d(o); for (var r, c, t, s = 0, l = e.sources.length; s < l; s++)
    ...
    function re(e, o, u, n) { var r; if (e === null) {
        var c = o;
        r = { sourceMappingURL: null, url: c, sourcesRelativeTo: c, map: null }, r.map = L(u, c, r), r.map = f(r.map, r);
    }
    else if (r = D(e, o, u), !r)

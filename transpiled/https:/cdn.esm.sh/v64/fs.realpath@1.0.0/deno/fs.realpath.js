...
var C = z(b => { var k = __path$, O = __Process$.platform === "win32", S = __fs$, X = __Process$.env.NODE_DEBUG && /fs/.test(__Process$.env.NODE_DEBUG); function Y() { var t; if (X) {
    var r = new Error;
    t = n;
}
else
...
} } } function R(t) { return typeof t == "function" ? t : Y(); } var ar = k.normalize; O ? y = /(.*?)(?:[\/\\]+|$)/g : y = /(.*?)(?:[\/]+|$)/g; var y; O ? $ = /^(?:[a-zA-Z]:|[\\\/]{2}[^\\\/]+[\\\/][^\\\/]+)?[\\\/]*/ : $ = /^[\/]*/; var $; b.realpathSync = function (r, n) { if (r = k.resolve(r), n && Object.prototype.hasOwnProperty.call(n, r))
    return n[r]; var l = r, e = {}, s = {}, f, u, i, o; g(); function g() { var a = $.exec(r); f = a[0].length, u = a[0], i = a[0], o = "", O && !s[i] && (S.lstatSync(i), s[i] = !0); } for (; f < r.length;) {
    y.lastIndex = f;
    var E = y.exec(r);
    if (o = u, u += E[0], i = o + E[1], f = y.lastIndex, !(s[i] || n && n[i] === i)) {
        ...
        if (n && Object.prototype.hasOwnProperty.call(n, i))
            ...
            p === null && (S.statSync(i), p = S.readlinkSync(i)), v = k.resolve(o, p), n && (n[i] = v), O || (e[w] = p);
        }
    ...
    return __Process$.nextTick(l.bind(null, null, n[r])); var e = r, s = {}, f = {}, u, i, o, g; E(); function E() { var a = $.exec(r); u = a[0].length, i = a[0], o = a[0], g = "", O && !f[o] ? S.lstat(o, function (m) { if (m)
    return l(m); f[o] = !0, v(); }) : __Process$.nextTick(v); } function v() { if (u >= r.length)
    return n && (n[e] = r), l(null, r); y.lastIndex = u; var a = y.exec(r); return g = i, i += a[0], o = g + a[1], u = y.lastIndex, f[o] || n && n[o] === o ? __Process$.nextTick(v) : n && Object.prototype.hasOwnProperty.call(n, o) ? w(n[o]) : S.lstat(o, D); } function D(a, m) { if (a)
    return l(a); if (!m.isSymbolicLink())
    return f[o] = !0, n && (n[o] = o), __Process$.nextTick(v); if (!O) {
    var x = m.dev.toString(32) + ":" + m.ino.toString(32);
    if (s.hasOwnProperty(x))
        return p(null, s[x], o);
} S.stat(o, function (L) { if (L)
    return l(L); S.readlink(o, function (P, M) { O || (s[x] = M), p(P, M); }); }); } function p(a, m, x) { if (a)

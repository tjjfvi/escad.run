...
var W = N((F, B) => {
    "use strict";
    (function (d, r) { typeof define == "function" && define.amd ? define(r) : typeof F == "object" ? B.exports = r() : d.ResizeSensor = r(); })(typeof window != "undefined" ? window : F, function () { if (typeof window == "undefined")
        return null; var d = typeof window != "undefined" && window.Math == Math ? window : typeof self != "undefined" && self.Math == Math ? self : Function("return this")(), r = d.requestAnimationFrame || d.mozRequestAnimationFrame || d.webkitRequestAnimationFrame || function (u) { return d.setTimeout(u, 20); }, T = d.cancelAnimationFrame || d.mozCancelAnimationFrame || d.webkitCancelAnimationFrame || function (u) { d.clearTimeout(u); }; function f(u, h) { var s = Object.prototype.toString.call(u), A = s === "[object Array]" || s === "[object NodeList]" || s === "[object HTMLCollection]" || s === "[object Object]" || typeof jQuery != "undefined" && u instanceof jQuery || typeof Elements != "undefined" && u instanceof Elements, q = 0, n = u.length; if (A)
        for (; q < n; q++)
            h(u[q]);
    else
    ...
    } } f(u, function (n) { q(n, h); }), this.detach = function (n) { s || (T(s), s = 0), M.detach(u, n); }, this.reset = function () { u.resizeSensor.resetSensor(); }; }; if (M.reset = function (u) { f(u, function (h) { h.resizeSensor.resetSensor(); }); }, M.detach = function (u, h) { f(u, function (s) { !s || s.resizedAttached && typeof h == "function" && (s.resizedAttached.remove(h), s.resizedAttached.length()) || s.resizeSensor && (s.contains(s.resizeSensor) && s.removeChild(s.resizeSensor), delete s.resizeSensor, delete s.resizedAttached); }); }, typeof MutationObserver != "undefined") {
...
var K = N(($, D) => {
    "use strict";
    (function (d, r) { typeof define == "function" && define.amd ? define(["./ResizeSensor.js"], r) : typeof $ == "object" ? D.exports = r(W()) : (d.ElementQueries = r(d.ResizeSensor), d.ElementQueries.listen()); })(typeof window != "undefined" ? window : $, function (d) {
        var r = function () {
            var f, m = {}, b = [];
...
` + e + " > .resize-sensor {min-width: " + a + "px;}", b.push(e);
            ...
            function q(e) { var t; if (document.querySelectorAll && (t = e ? e.querySelectorAll.bind(e) : document.querySelectorAll.bind(document)), !t && typeof $$ != "undefined" && (t = $$), !t && typeof jQuery != "undefined" && (t = jQuery), !t)
            ...
            this.init = function () {
                ...
                typeof document.documentElement.style.webkitAnimationName != "undefined" ? e = "webkitAnimationStart" : typeof document.documentElement.style.MozAnimationName != "undefined" ? e = "mozanimationstart" : typeof document.documentElement.style.OAnimationName != "undefined" && (e = "oanimationstart"), document.body.addEventListener(e, function (o) { var a = o.target, l = a && window.getComputedStyle(a, null), w = l && l.getPropertyValue("animation-name"), c = w && w.indexOf("element-queries") !== -1; if (c) {

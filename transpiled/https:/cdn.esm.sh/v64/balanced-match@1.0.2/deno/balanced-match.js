...
var p = b((A, m) => {
    "use strict";
    m.exports = h;
    function h(e, n, i) { e instanceof RegExp && (e = s(e, i)), n instanceof RegExp && (n = s(n, i)); var t = x(e, n, i); return t && { start: t[0], end: t[1], pre: i.slice(0, t[0]), body: i.slice(t[0] + e.length, t[1]), post: i.slice(t[1] + n.length) }; }
    function s(e, n) { var i = n.match(e); return i ? i[0] : null; }
    h.range = x;

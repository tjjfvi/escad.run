...
import { ERR_FS_EISDIR, ERR_FS_INVALID_SYMLINK_TYPE, ERR_INVALID_ARG_TYPE, ERR_INVALID_ARG_VALUE, ERR_OUT_OF_RANGE, hideStackFrames, uvException, } from "/transpiled/https://deno.land/std@0.122.0/node/_errors.js";
import { isArrayBufferView, isBigUint64Array, isDate, isUint8Array, } from "/transpiled/https://deno.land/std@0.122.0/node/internal/util/types.js";
import { once } from "/transpiled/https://deno.land/std@0.122.0/node/internal/util.js";
import { toPathIfFileURL } from "/transpiled/https://deno.land/std@0.122.0/node/internal/url.js";
import { validateAbortSignal, validateBoolean, validateFunction, validateInt32, validateInteger, validateObject, validateUint32, } from "/transpiled/https://deno.land/std@0.122.0/node/internal/validators.js";
import pathModule from "/transpiled/https://deno.land/std@0.122.0/node/path.js";
const kType = Symbol("type");
const kStats = Symbol("stats");
import assert from "/transpiled/https://deno.land/std@0.122.0/node/internal/assert.js";
import fs from "/transpiled/https://deno.land/std@0.122.0/node/fs.js";
import { isWindows } from "/transpiled/https://deno.land/std@0.122.0/_util/os.js";
import process from "/transpiled/https://deno.land/std@0.122.0/node/process.js";
import { fs as fsConstants, os as osConstants, } from "/transpiled/https://deno.land/std@0.122.0/node/internal_binding/constants.js";

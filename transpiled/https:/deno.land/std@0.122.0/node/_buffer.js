...
import { ERR_BUFFER_OUT_OF_BOUNDS, ERR_INVALID_ARG_TYPE, ERR_INVALID_ARG_VALUE, ERR_OUT_OF_RANGE, ERR_UNKNOWN_ENCODING, } from "/transpiled/https://deno.land/std@0.122.0/node/_errors.js";
import { isAnyArrayBuffer, isArrayBufferView } from "/transpiled/https://deno.land/std@0.122.0/node/internal/util/types.js";
import { normalizeEncoding } from "/transpiled/https://deno.land/std@0.122.0/node/internal/util.js";
import { _copyActual, _writeUInt32BE, _writeUInt32LE, bigEndian, boundsError, byteLengthUtf8, encodingOps, encodingsMap, getEncodingOps, readDoubleBackwards, readDoubleForwards, readFloatBackwards, readFloatForwards, readInt24BE, readInt24LE, readInt40BE, readInt40LE, readInt48BE, readInt48LE, readUInt16BE, readUInt24BE, readUInt24LE, readUInt32BE, readUInt40BE, readUInt40LE, readUInt48BE, readUInt48LE, toInteger, validateNumber, validateOffset, writeDoubleBackwards, writeDoubleForwards, writeFloatBackwards, writeFloatForwards, 
...
writeU_Int48LE, 
// deno-lint-ignore camelcase
writeU_Int8, } from "/transpiled/https://deno.land/std@0.122.0/node/internal/buffer.js";
import { asciiToBytes, base64ToBytes, base64UrlToBytes, bytesToAscii, bytesToUtf16le, hexToBytes, utf16leToBytes, } from "/transpiled/https://deno.land/std@0.122.0/node/internal_binding/_utils.js";
import { indexOfBuffer, indexOfNumber } from "/transpiled/https://deno.land/std@0.122.0/node/internal_binding/buffer.js";
import { validateBuffer } from "/transpiled/https://deno.land/std@0.122.0/node/internal/validators.js";
...
Buffer.prototype.readBigInt64LE = defineBigIntMethod(function readBigInt64LE(offset) {
    ...
    return (BigInt(val) << BigInt(32)) +
        BigInt(first + this[++offset] * 2 ** 8 + this[++offset] * 2 ** 16 +
            this[++offset] * 2 ** 24);
});
Buffer.prototype.readBigInt64BE = defineBigIntMethod(function readBigInt64BE(offset) {
    ...
    const val = (first << 24) + this[++offset] * 2 ** 16 +
        this[++offset] * 2 ** 8 + this[++offset];
    return (BigInt(val) << BigInt(32)) +
        BigInt(this[++offset] * 2 ** 24 + this[++offset] * 2 ** 16 +
            this[++offset] * 2 ** 8 + last);
});

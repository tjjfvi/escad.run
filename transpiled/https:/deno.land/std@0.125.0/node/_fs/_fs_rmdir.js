...
import { emitRecursiveRmdirWarning, getValidatedPath, validateRmdirOptions, validateRmOptions, validateRmOptionsSync, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/fs/utils.js";
import { toNamespacedPath } from "/transpiled/https://deno.land/std@0.125.0/node/path.js";
import { denoErrorToNodeError, ERR_FS_RMDIR_ENOTDIR, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/errors.js";

...
import { ERR_FS_EISDIR, ERR_FS_INVALID_SYMLINK_TYPE, ERR_INVALID_ARG_TYPE, ERR_INVALID_ARG_VALUE, ERR_OUT_OF_RANGE, hideStackFrames, uvException, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/errors.js";
import { isArrayBufferView, isBigUint64Array, isDate, isUint8Array, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/util/types.js";
import { once } from "/transpiled/https://deno.land/std@0.125.0/node/internal/util.js";
import { toPathIfFileURL } from "/transpiled/https://deno.land/std@0.125.0/node/internal/url.js";
import { validateAbortSignal, validateBoolean, validateFunction, validateInt32, validateInteger, validateObject, validateUint32, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/validators.js";
import pathModule from "/transpiled/https://deno.land/std@0.125.0/node/path.js";
const kType = Symbol("type");
const kStats = Symbol("stats");
import assert from "/transpiled/https://deno.land/std@0.125.0/node/internal/assert.js";
...
export function Stats(dev, mode, nlink, uid, gid, rdev, blksize, ino, size, blocks, atimeMs, mtimeMs, ctimeMs, birthtimeMs) {

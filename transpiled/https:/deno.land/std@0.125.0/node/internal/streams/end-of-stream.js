...
import { AbortError, ERR_STREAM_PREMATURE_CLOSE } from "/transpiled/https://deno.land/std@0.125.0/node/internal/errors.js";
import { once } from "/transpiled/https://deno.land/std@0.125.0/node/internal/util.js";
import { validateAbortSignal, validateFunction, validateObject, } from "/transpiled/https://deno.land/std@0.125.0/node/internal/validators.js";
...
function eos(stream, options, callback) {
    ...
    // this generic check.
    let willEmitClose = isServerResponse(stream) || (state &&
        state.autoDestroy &&
        state.emitClose &&
        state.closed === false &&
    ...
    const closed = (!wState && !rState && stream._closed === true) || ((wState && wState.closed) ||

...
import { CHAR_DOT, CHAR_FORWARD_SLASH } from "/transpiled/https://deno.land/std@0.118.0/path/_constants.js";
import { _format, assertPath, encodeWhitespace, isPosixPathSeparator, normalizeString } from "/transpiled/https://deno.land/std@0.118.0/path/_util.js";
export const sep = "/";
export const delimiter = ":"; // path.resolve([from ...], to)
